# Тестові інтернет-радіопотоки для RadioReel

> **Призначення:** набір реальних, публічно доступних потоків для тестування ICY/SHOUTcast клієнта — розробки і відлагодження RadioReel.
